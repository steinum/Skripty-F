...
try
{
	...
	//---------------------CONFIGURABLES-------------------------------------------------------------
	var query = "SELECT objname FROM FSCFOLIO@1.1001:Organisation";
//var query = "LIMIT 10 SELECT objname FROM FSCFOLIO@1.1001:Organisation";
//var query = "SELECT objname FROM COOSYSTEM@1.1:Object WHERE .COOSYSTEM@1.1:objaddress = \"COO.200.200.4.352\"";
	...
	var logPath = "C:\\OrganisationToOsobaAnonym_log_"+dateFormated+".txt";
